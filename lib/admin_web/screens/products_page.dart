                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                            ...
                            child: const Row(
                              children: [
                                Expanded(flex: 1, child: Text("الصورة", style: TextStyle(fontWeight: FontWeight.bold))),
                                Expanded(flex: 2, child: Text("اسم المنتج", style: TextStyle(fontWeight: FontWeight.bold))),
                                Expanded(flex: 1, child: Text("رقم المنتج", style: TextStyle(fontWeight: FontWeight.bold))),
                                Expanded(flex: 1, child: Text("السعر", style: TextStyle(fontWeight: FontWeight.bold))),
                                Expanded(flex: 1, child: Text("الحجم", style: TextStyle(fontWeight: FontWeight.bold))),
                                Expanded(flex: 1, child: Text("الكمية", style: TextStyle(fontWeight: FontWeight.bold))),
                                Expanded(flex: 2, child: Text("الوصف", style: TextStyle(fontWeight: FontWeight.bold))),
                                Expanded(flex: 1, child: Center(child: Text("الإجراءات", style: TextStyle(fontWeight: FontWeight.bold)))),
                              ],
                            ),
                          ),
